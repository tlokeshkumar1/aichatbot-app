        ...
        <div className="container">
          <section className="booking-form">
            ...
            <form id="ticketForm" onSubmit={submit}>
              ...
              <input type="date" onChange={(e) => setDateTime(e.target.value)} id="date" name="date" required />

              <label htmlFor="busType">Bus Type:</label>
              <input type="text" onChange={(e) => setBusType(e.target.value)} id="busType" name="busType" required />

              <label htmlFor="passengers">Number of Passengers:</label>
              <input type="number" onChange={(e) => setSeatNumber(e.target.value)} id="passengers" name="passengers" required min="1" />
